    ...
    <div class="white-block">
      ...
      <div class="content-container">
        ...
        <div class="cat-facts-container">
          <div class="cat-facts">
            <h2 class="center-text cat-facts-title">
              Интересные факты о кошках
            </h2>
            <ul class="cat-facts-list">
              <li
                v-for="fact in catFacts"
                :key="fact.length"
                class="cat-fact-item"
              >
        ...
        <div class="photos-container">
          ...
          <img
            src="https://avatars.dzeninfra.ru/get-zen_doc/96506/pub_5be3e9401bff3000ab1c55e3_5be3e9e829b2fc00a917866c/orig"
            alt="Photo 1"
            class="photo-item"
          />
          <img
            src="../assets/photo/oskar.jpg"
            alt="Photo 2"
            class="photo-item"
          />
          <img
            src="https://s9.travelask.ru/uploads/post/000/029/496/main_image/full-8be99e670c82a7dd22eeab986855ecb8.jpg"
            alt="Photo 3"
            class="photo-item"
          />
          <img
            src="https://cs12.pikabu.ru/images/big_size_comm_an/2021-01_6/161187164813667781.gif"
            alt="Photo 4"
            class="photo-item"
          />
        </div>
    ...
    async fetchCatFacts() {
      try {
        ...
        const response = await axios.get(
          "https://catfact.ninja/facts?max_length=600&limit=20"
        );
